...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            String time= NotificationConfig.getCurrentTime();
            ...
            if (TextUtils.isEmpty(imageUrl)) {
                showNotificationMessage(getApplicationContext(), title, message, time, resultIntent);
            } else {
                // image is present, show notification with image
                showNotificationMessageWithBigImage(getApplicationContext(), title, message, time, resultIntent, imageUrl);
            }
