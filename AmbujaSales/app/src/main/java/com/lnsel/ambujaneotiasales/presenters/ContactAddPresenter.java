...
import com.lnsel.ambujaneotiasales.views.Dashboard.activities.ContactAddScreen.ContactAddActivityView;

/**
 * Created by apps2 on 5/29/2017.
 */
public class ContactAddPresenter {
    private ContactAddActivityView view;

    private static final String TAG = "REQ";

    public ContactAddPresenter(ContactAddActivityView view) {
        this.view = view;
    }

    public void addContactService(String url, final String userId, final String userParentPath, final String cntPersonName, final String cntContactNo, final String cntAddress, final String cntOtherDetails){
