 ...
 */
public class CustomerDetailsSetterGetter {
    ...
    public CustomerDetailsSetterGetter(String mtnId, String mtnName, String mtnDate, String mtnTime, String mtnUserName, String mtnVisited, String mtnCompleted, String mtnRemarksMessage) {
        this.mtnId = mtnId;
