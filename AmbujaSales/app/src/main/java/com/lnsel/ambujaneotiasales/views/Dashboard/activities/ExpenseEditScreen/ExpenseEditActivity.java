package com.lnsel.ambujaneotiasales.views.Dashboard.activities.ExpenseEditScreen;
...
import com.lnsel.ambujaneotiasales.presenters.ExpenseEditPresenter;
 ...
 */
public class ExpenseEditActivity extends AppCompatActivity implements ExpenseEditActivityView {

    private static final float maxHeight = 1280.0f;
    private static final float maxWidth = 1280.0f;

    private ExpenseEditPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new ExpenseEditPresenter(this);

        et_expense_title = (EditText) findViewById(R.id.activity_expense_edit_et_title);
        et_expense_amount = (EditText) findViewById(R.id.activity_expense_edit_et_amount);
        et_expense_description = (EditText) findViewById(R.id.activity_expense_edit_et_description);

        btn_cancel = (Button) findViewById(R.id.activity_expense_edit_btn_cancel);
        btn_submit = (Button) findViewById(R.id.activity_expense_edit_btn_submit);
        ib_expense_image = (ImageButton) findViewById(R.id.activity_expense_edit_ib_add_image);
        iv_expense_image = (ImageView) findViewById(R.id.activity_expense_edit_iv_image);

        til_expense_title = (TextInputLayout) findViewById(R.id.activity_expense_edit_til_title);
        til_expense_amount = (TextInputLayout) findViewById(R.id.acitvity_expense_edit_til_amount);
        til_expense_description = (TextInputLayout) findViewById(R.id.activity_expense_edit_til_description);
        ...
        et_expense_title.setText(ExpensesData.current_expense_title);
        et_expense_amount.setText(ExpensesData.current_expense_amount);
        et_expense_description.setText(ExpensesData.current_expense_description);

        if(ExpensesData.current_expense_image_status.equals("true")){

            ImageLoader imageLoader = AppController.getInstance().getImageLoader();
            imageLoader.get(ExpensesData.current_expense_image, new ImageLoader.ImageListener() {
        ...
        ib_expense_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hasPermissionRead = (ContextCompat.checkSelfPermission(ExpenseEditActivity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);
                if (!hasPermissionRead) {
                    ActivityCompat.requestPermissions(ExpenseEditActivity.this,
                            new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                            REQUEST_READ_STORAGE);
                }

                hasPermissionCamera = (ContextCompat.checkSelfPermission(ExpenseEditActivity.this,
                        Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED);
                if (!hasPermissionCamera) {
                    ActivityCompat.requestPermissions(ExpenseEditActivity.this,
                            new String[]{Manifest.permission.CAMERA},
    ...
    public void submitPicture(){
        ...
        if(isNetworkAvailable()){
                ...
                String expId = ExpensesData.current_expense_id;
                ...
                if(photo_bitmap!=null) {
                    ...
                    presenter.updateExpenseService(UrlUtil.UPDATE_EXPENSE_URL, userId, expId, mtnPictureImageName, expTitle, expAmount, expDescription, expImageStatus, expImageAvailable, image);
                }else{
                    image = "NA";
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            switch (view.getId()) {
                case R.id.activity_expense_edit_et_title:
                    validateExpenseTitle();
                    break;
                case R.id.activity_expense_edit_et_amount:
                    validateExpenseAmount();
                    break;
                case R.id.activity_expense_edit_et_description:
