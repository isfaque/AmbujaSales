package com.lnsel.ambujaneotiasales.views.Dashboard.activities.CustomerAddScreen;
...
public class CustomerAddActivity extends AppCompatActivity implements CustomerAddActivityView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        et_first_name = (EditText) findViewById(R.id.activity_customer_add_et_first_name);
        et_last_name = (EditText) findViewById(R.id.activity_customer_add_et_last_name);
        et_dob = (EditText) findViewById(R.id.activity_customer_add_et_customer_dob);
        et_doa = (EditText) findViewById(R.id.activity_customer_add_et_customer_anniversary);
        et_mobile_no = (EditText) findViewById(R.id.activity_customer_add_et_mobile_no);
        et_alternate_no = (EditText) findViewById(R.id.activity_customer_add_et_alternate_no);
        et_email = (EditText) findViewById(R.id.activity_customer_add_et_email);
        et_address = (EditText) findViewById(R.id.activity_customer_add_et_address);
        et_landmark = (EditText) findViewById(R.id.activity_customer_add_et_landmark);
        et_pin_code = (EditText) findViewById(R.id.activity_customer_add_et_pin_code);

        act_company_name = (AutoCompleteTextView) findViewById(R.id.activity_customer_add_act_company_name);
        act_department = (AutoCompleteTextView) findViewById(R.id.activity_customer_add_act_department);
        act_designation = (AutoCompleteTextView) findViewById(R.id.activity_customer_add_act_designation);
        act_area = (AutoCompleteTextView) findViewById(R.id.activity_customer_add_act_area);

        spinner_gender = (Spinner) findViewById(R.id.activity_customer_add_spinner_gender);
        spinner_customer_type = (Spinner) findViewById(R.id.activity_customer_add_spinner_customer_type);
        spinner_industry_type = (Spinner) findViewById(R.id.activity_customer_add_spinner_industry_type);
        spinner_country = (Spinner) findViewById(R.id.activity_customer_add_spinner_country);
        spinner_state = (Spinner) findViewById(R.id.activity_customer_add_spinner_state);
        spinner_city = (Spinner) findViewById(R.id.activity_customer_add_spinner_city);

        til_first_name = (TextInputLayout) findViewById(R.id.activity_customer_add_til_first_name);
        til_last_name = (TextInputLayout) findViewById(R.id.activity_customer_add_til_last_name);
        til_company_name = (TextInputLayout) findViewById(R.id.activity_customer_add_til_company_name);
        til_mobile_no = (TextInputLayout) findViewById(R.id.activity_customer_add_til_mobile_no);
        til_email = (TextInputLayout) findViewById(R.id.activity_customer_add_til_email);
        til_address = (TextInputLayout) findViewById(R.id.activity_customer_add_til_address);
        til_area = (TextInputLayout) findViewById(R.id.activity_customer_add_til_area);
        til_pin_code = (TextInputLayout) findViewById(R.id.activity_customer_add_til_pin_code);
        ...
        btn_cancel = (Button) findViewById(R.id.activity_customer_add_btn_cancel);
        btn_submit = (Button) findViewById(R.id.activity_customer_add_btn_submit);
        ...
        genderAdapter = new ArrayAdapter<String>(CustomerAddActivity.this,R.layout.spinner_rows, genderList);
        genderAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_gender.setAdapter(genderAdapter);

        industryTypeAdapter = new ArrayAdapter<String>(CustomerAddActivity.this,R.layout.spinner_rows, industryTypeList);
        ...
        customerTypeAdapter = new ArrayAdapter<String>(CustomerAddActivity.this,R.layout.spinner_rows, customerTypeList);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(industryTypeIdSelected.isEmpty()||industryTypeIdSelected.equalsIgnoreCase("-1")){
                    ...
                    Toast.makeText(CustomerAddActivity.this,"please select industry type",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void submitNewCustomerMeeting(){
        ...
        if(isNetworkAvailable()){
            ...
            if(!gpsEnabled){
                ...
                presenter.addNewCustomerService(
                        UrlUtil.ADD_NEW_CUSTOMER,
                        userId,
                        userParentPath,
                        cusFirstName,
                        cusLastName,
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            switch (view.getId()) {
                case R.id.activity_customer_add_et_email:
                    validateEmail();
                    break;
                case R.id.activity_customer_add_et_mobile_no:
                    validateMobile();
                    break;
                case R.id.activity_customer_add_et_first_name:
                    validateFirstName();
                    break;
                case R.id.activity_customer_add_et_last_name:
                    validateLastName();
                    break;
                case R.id.activity_customer_add_act_company_name:
                    validateCompanyName();
                    break;
                case R.id.activity_customer_add_et_address:
                    validateAddress();
                    break;
                case R.id.activity_customer_add_et_pin_code:
                    validatePinCode();
                    break;
            }
        }
